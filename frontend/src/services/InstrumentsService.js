...
const INSTRUMENTS_BASE_URL =
  'http://localhost:3333/odata/v4/catalog/Instruments';
...
class InstrumentsService {
  ...
  /**
   * Obtener instruments crudos desde la API externa.
   * Devuelve un array de objetos (la respuesta original de instruments),
   * NO mapeado aún para combos.
   */
